...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\ShopLite\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\ShopLite\\public\\storage','inertia.ssr.enabled','inertia.ssr.url',
...
'web','api',);
        registerArgumentsSet('routes', 'home','dashboard','admin.category.index','admin.category.create',
'admin.category.store','profile.edit','profile.update','profile.destroy',
